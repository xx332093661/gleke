...
#     APPID = config.get('public_appid')
#     # JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
#     # APPSECRET = "48888888888888888888888888888887"
#     APPSECRET = config.get('public_appsecret')
#     # 受理商ID，身份标识
#     # MCHID = "18888887"
...
#     NOTIFY_URL = "http://121.201.68.100/web/app/payback"
#
#     # =======【JSAPI路径设置】===================================
#     # 获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
#     JS_API_CALL_URL = "http://121.201.68.100/web/app/pay/?showwxpaytitle=1"
#
#     # =======【证书路径设置】=====================================
#     # 证书路径,注意应该填写绝对路径
#     SSLCERT_PATH = "/******/cacert/apiclient_cert.pem"
#     SSLKEY_PATH = "/etc/rsa_private_key.pem.pem"
#     # SSLKEY_PATH = "D:\\rsa_private_key.pem"
#
#     # =======【curl超时设置】===================================
#     CURL_TIMEOUT = 30
#
...
class JsApi_pub(Common_util_pub):
    ...
    def __init__(self, appid, mch_id, api_key, timeout=CURL_TIMEOUT):
        self.curl_timeout = timeout

        super(JsApi_pub, self).__init__(appid, mch_id, api_key)
...
class Wxpay_client_pub(Common_util_pub):
    ...
    def __init__(self, appid, mch_id, api_key):
        ...
        super(Wxpay_client_pub, self).__init__(appid, mch_id, api_key)
...
class UnifiedOrder_pub(Wxpay_client_pub):
    ...
    def __init__(self, appid, mch_id, api_key, timeout=CURL_TIMEOUT):
        ...
        super(UnifiedOrder_pub, self).__init__(appid, mch_id, api_key)
...
class OrderQuery_pub(Wxpay_client_pub):
    ...
    def __init__(self, appid, mch_id, api_key, timeout=CURL_TIMEOUT):
        ...
        super(OrderQuery_pub, self).__init__(appid, mch_id, api_key)
...
class Refund_pub(Wxpay_client_pub):
    ...
    def __init__(self, appid, mch_id, api_key, timeout=CURL_TIMEOUT):
        ...
        # 设置curl超时时间
        self.curl_timeout = timeout
        super(Refund_pub, self).__init__(appid, mch_id, api_key)
...
class RefundQuery_pub(Wxpay_client_pub):
    ...
    def __init__(self, appid, mch_id, api_key, timeout=CURL_TIMEOUT):
        ...
        # 设置curl超时时间
        self.curl_timeout = timeout
        super(RefundQuery_pub, self).__init__(appid, mch_id, api_key)
...
class DownloadBill_pub(Wxpay_client_pub):
    ...
    def __init__(self, appid, mch_id, api_key, timeout=CURL_TIMEOUT):
        ...
        # 设置curl超时时间
        self.curl_timeout = timeout
        super(DownloadBill_pub, self).__init__(appid, mch_id, api_key)
...
class ShortUrl_pub(Wxpay_client_pub):
    ...
    def __init__(self, appid, mch_id, api_key, timeout=CURL_TIMEOUT):
        ...
        # 设置curl超时时间
        self.curl_timeout = timeout
        super(ShortUrl_pub, self).__init__(appid, mch_id, api_key)
...
class Wxpay_server_pub(Common_util_pub):
    ...
    def __init__(self, appid, mch_id, api_key):
        ...
        super(Wxpay_server_pub, self).__init__(appid, mch_id, api_key)
...
class NativeCall_pub(Wxpay_server_pub):
    ...
    def createXml(self):
        ...
        if self.returnParameters["return_code"] == self.SUCCESS:
            self.returnParameters["appid"] = self.appid  # 公众账号ID
            self.returnParameters["mch_id"] = self.mch_id  # 商户号
...
class NativeLink_pub(Common_util_pub):
    ...
    def __init__(self, appid, mch_id, api_key):
        ...
        super(NativeLink_pub, self).__init__(appid, mch_id, api_key)
    ...
    def createLink(self):
        ...
        self.parameters["appid"] = self.appid  # 公众账号ID
        self.parameters["mch_id"] = self.appid  # 商户号
